...
final List<OnBoardModel> onBoardData = [
  OnBoardModel(
    title: "Tingkatkan skill bahasa jepangmu",
    description: "Terdapat fitur kamus, kalimat dan latihan untuk meningkatkan skill bahasa jepangmu",
    imgUrl: "assets/images/welcome.png",
  ),
  OnBoardModel(
    title: "Kamus bahasa jepang",
    description:
    "Banyak kata bahasa jepang baru yang dapat kamu pelajari",
    imgUrl: 'assets/images/kamus.png',
  ),
  OnBoardModel(
    title: "Latihan pelafalan bahasa jepang",
    description:
    "Selesaikan semua modul latihan yang tersedia",
